...
{   
    ...
    {
        var reg = /^[a-zA-Z0-9\s]+$/;
        if (reg.test(groupname) && groupname.trim().length <=20)
        {
            document.getElementById("groupName_div").innerHTML = "";
        ...
        } else
        {
            ...
            {
            document.getElementById("groupName_div").innerHTML = "";
            document.getElementById("groupName_div").innerHTML = "Group name must not exceed 20 characters";
            document.getElementById("groupName_div").style.color = "red";
            document.getElementById("submitButtonNew").disabled = true; 
            }
            else
...
function validateDescription()
{
    ...
    if (description.trim().length == 0) {
        ...
        {
        document.getElementById("desc_error").innerHTML = "Enter a valid description";
        document.getElementById("desc_error").style.color = "red";
        document.getElementById("submitButtonNew").disabled = true;
        }
    }
...
function validateGroupName(gname) {
  var  groupName = gname.trim();
...
function validGroupName(data) {
    ...
    if (data > 0) {
        ...
        document.getElementById("groupName_div").innerHTML = "";
        document.getElementById("groupName_div").innerHTML = "group name approved";
        document.getElementById("groupName_div").style.color = "green";
        document.getElementById("submitButtonNew").disabled = false;
        
    } else {
        
        document.getElementById("groupName_div").innerHTML = "";
        document.getElementById("groupName_div").innerHTML = "Group Name already taken";
        document.getElementById("groupName_div").style.color = "red";
        document.getElementById("submitButtonNew").disabled = true;
    ...
    for (var i = 0, keys = Object.keys(x); i < (Object.keys(x).length); i += 2)
    {
        ...
        if (x[keys[i]])
        {
            ...
            for (j in featureRights[keys[i]])
            {
                ...
                var chk = t.charAt(featureRights[keys[i]][j].length - 1);
                ...
                var input = document.createElement("input");
                input.id = t;
                mp[t.substring(0, t.length - 1)] = chk;
                input.type = "checkbox";
                input.addEventListener("click", function () {
                    functn(this.id)
                }, false);
                ...
                tableData.innerHTML = t.substring(0, t.length - 1);
        ...
        document.getElementById("replace2").appendChild(maindiv);
    }
    $('#rightsModal2').modal('show');
    document.getElementById("rightsModal2").style = "z-index:9999;";
...
function checkExistingProfile2()
{
    document.getElementById("Button22").disabled = true;
    var profileName = document.getElementById("newProfile1").value;
    var reg = /^[a-zA-Z0-9\s]+$/;
    document.getElementById("error_divvv").innerHTML = "";
    if (profileName.trim().length == 0)
    {
        document.getElementById("error_divvv").style.innerHTML = "Enter a Profile Name";
    } else
    {
        if (reg.test(profileName))
        {
            document.getElementById("error_divvv").style.innerHTML = "";
            ...
            $.ajax({
                ...
                data: data,
                dataType: "json",
                success: validProfileName2,
                error: onError
            });
        } else
        {
            document.getElementById("error_divvv").style.innerHTML = "Invalid Profile Name";
            document.getElementById("error_divvv").style.color = "red";
        }
...
function validProfileName2(data)
{
    document.getElementById("Button22").disabled = true;
    if (data > 0)
    {
        document.getElementById("error_divvv").innerHTML = "Profile Name Already Exists.";
        document.getElementById("error_divvv").style.color = "red";
        document.getElementById("Button22").disabled = true;
    } else {

        document.getElementById("error_divvv").innerHTML = "Valid Profile Name";
        document.getElementById("error_divvv").style.color = "green";
...
function functn(se)
{
    ...
    //alert(mp[se.substring(0,se.length-1)]);
}
/*
...
function convertMapToString3()
{
    ...
    str = str.substring(0, str.length - 1);
    insertNewProfile3(str);
}

function convertMapToString2(gid)
{
...
function insertNewProfile2(rights,gid)
{
    var data;
    ...
    data = "rights=" + rights + "&profileName=" + profileName +"&gid="+gid;

    $.ajax({
        url: "angle_group/DAO_addNewProfile2.jsp",
        type: "GET",
        data: data,
        dataType: "json",
        success: newProfileAdded2,
        error: onError
    });
...
function newProfileAdded2(data)
{
    ...
    if (data)
    {
        ...
        {
            window.location="MainGroupPage.html?groupId="+data;
        }
    } else
    {
...
function insertNewProfile3(rights)
{
    var data;
    ...
    $.ajax({
        ...
        data: data,
        dataType: "json",
        success: newProfileAdded3,
        error: onError
    });


}
function newProfileAdded3(data)
{   //alert(data);
...
function roleChanged(data)
{
    ...
    if (data != "null")
    {
        ...
        var temp3="roleOfMember"+temp[1];
        
        document.getElementById(temp3).innerHTML = temp[0];
    }
...
function newGroupCreated(data)
{
    ...
    var gid = res[0];
    var gname = document.getElementById("newGroupName").value;
    var link = 'http://localhost:8084/test/newcategory.jsp?category=' + gname + '&desc=' + desc + '&id=' + gid;
 ...
 * @author Apurv & Sakshi
 */
function displayTheToDoList(groupId) 
{    
...
function displayTemp(data)
{
    ...
    for (var i = 0; i < arr.length; i++) {
        ...
        {  
            ...
            div2.className="col-md-12  col-xs-12";
...
function addTopic()
{
    ...
    {
       document.getElementById("link_div1").innerHTML = "Enter a Topic Name";
        document.getElementById("Button1").disabled = true;
        document.getElementById("link_div1").style.color = "red";
    } else
    {       document.getElementById("link_div1").innerHTML = "";
            document.getElementById("link_div1").display = "none";
...
function checkExisting(tname) {
    ...
    {
        var reg = /^[a-zA-Z0-9\s]+$/;
        if (reg.test(tname) && tname.trim().length <=20)
        {
            document.getElementById("link_div1").innerHTML = "";
            document.getElementById("link_div1").display = "none";
            document.getElementById("Button1").disabled = false;
        ...
        {
            if(tname.trim().length>20)
            {
            document.getElementById("link_div1").innerHTML = "";
            document.getElementById("link_div1").innerHTML = "Topic name must not exceed 20 characters";
            document.getElementById("link_div1").style.color = "red";
            document.getElementById("Button1").disabled = true; 
            }
            else
...
function validateTopicName(tname, gid) {
    var topicName = tname.trim();
    var data = "topicname=" + topicName + "&gid=" + gid;
