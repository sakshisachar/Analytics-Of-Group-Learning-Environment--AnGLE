...
/*
        ...
        function setUnreadNotifications(data)
        {
            ...
            code += "<li><div  onclick=\"seeAllNotification();\" class=\"text-center\"><a><strong>See All Notifications &nbsp </strong><i class=\"fa fa-angle-right\"></i></a></div></li>";
        ...
        {
            window.location = 'AllNotification.html';
        }
    </script>
</body>