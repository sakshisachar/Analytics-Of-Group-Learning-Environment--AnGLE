...
<%
    ...
    Integer groupId = Integer.parseInt(request.getParameter("gid"));
    int i,res=0;
    String temp="";
    ...
    for(String key : rights_values.keySet())
    {
        ...
        else if(rht.equals("Create Topic"))
      {
        ...
        else if(rht.equals("Grade Assignment"))
      {
    ...
    try {
        temp = angle.addNewProfile2(profile,groupId);
    } catch (Exception e) {
