                                                    ...
                                                    <div class="w3-container col-sm-6">
                                                        <div class="w3-card-4">
                                                            ...
                                                            <div class="w3-container">
                                                                ...
                                                                <p><h4> No Of Members : <s:property value="#attr.allGroups.get(#cnt).noOfMembers"/></h4>
                                                                <p><h4><s:property value="#attr.allGroups.get(#cnt).lockedState"/> Group </h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <s:if test="#attr.group_list.get(#cnt).groupName != null">
                                                    <div class="w3-container col-sm-6">
                                                        <div class="w3-card-4">
                                                            <header class="w3-container">
                                                                <s:if test="#attr.group_list.get(#cnt).parentId == 0">
                                                                    <h1><s:property value="#attr.group_list.get(#cnt).groupName"/></h1>
                                                                </s:if>
                                                                <s:if test="#attr.group_list.get(#cnt).parentId != 0">
                                                                    <h1><s:property value="#attr.group_list.get(#cnt).groupName"/></h1>
                                                                    <h3><b>Parent Group : </b><s:property value="#attr.group_list.get(#cnt).parentName"/></h3>
                                                                </s:if>
                                                            ...
                                                            <div class="w3-container">
                                                                ...
                                                                <p><h4>No Of Members : <s:property value="#attr.group_list.get(#cnt).noOfMembers"/></h4>
                                                                
                                                                <p><h4> Your Profile : <s:property value="#attr.group_list.get(#cnt).profileName"/></h4>
                                            ...
                                            <form id="createGroup" name="createGroup"  onsubmit="return FormValidation();" method="post" action="create_group.html">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="groupName" class="form-control" name="g.groupName" onkeyup="groupNameValidation();"/>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                                            <div class="radio">
                                                                <label>
                                                                    <input type="radio" value="2" checked="" id="MentorAndStudent" name="g.groupType" class="flat" >Mentor And Student
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <textarea id="message"  class="form-control" name="g.description"  onkeyup      ="validateDescription();"></textarea>
                                                    </div>         
                                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                                        ...
                                                        <div class="row" style="margin-bottom: 5px;">
                                                            <div class="col-md-3">
                                                                <select id="sbOne"  multiple="multiple" onclick="rights(this.value);" data-toggle="modal"  data-target="#rightsModal">
                                                                    <option value = "-1" id="profile" disabled="" onclick="stopSelect();">Select Profiles</option>
