...
ArrayList<Profile> profile_list = new ArrayList<Profile>();
    ...
    public QuizReport getQuizReport() {
        return quizReport;
    }
    ...
    public String execute() {
        try {
            ...
            System.out.println("Size Of"+profilesList.size());
             profile_list = angle.getListOfProfiles();
           ...
           // System.out.println("profile Id" + profileId);
            ...
            parentId = angle.getParentId(gid);
            quizReport = angle.getQuizReport(uid, gid);
